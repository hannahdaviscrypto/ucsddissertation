...
\input{fig-mske-model}
\input{fig-mske-predicates}
...
The adversary can establish a random pre-shared key between a pair of users by calling $\NewSecret$.%
\footnote{%
...
\iffull
\fg{Strictly speaking, $\KEkeyspace$ is different per stage.}
\fi
...
\fg{Don't understand in which way this relates to protocol syntax, let's for full version.}
\fi
