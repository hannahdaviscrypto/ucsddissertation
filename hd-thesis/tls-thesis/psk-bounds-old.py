...
def ourPSKDHEbound(t, qn, qs, qRO, logp, nl, kl):
        ...
        coll_res = 2*(qRO+qs)**2/(2**(kl)) + 2/(2**(kl)) #binder collisions and Thash collisions
        MACadv = 2*qs/(2**kl) # probability of guessing a random MAC tag
        tB4 = tmaul + 2*qRO*logp #stDH reduction time: t + qRO exponentiations
